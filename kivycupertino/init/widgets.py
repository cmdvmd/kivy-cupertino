...
Factory.register('CupertinoNextButton', module='kivycupertino.uix.button')
...
Factory.register('CupertinoScreenManager', module='kivycupertino.uix.page')
Factory.register('CupertinoPageControls', module='kivycupertino.uix.page')
